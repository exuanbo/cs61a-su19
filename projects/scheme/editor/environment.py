    ...
    def execute_evaluated(self, operands: List[Expression], frame: Frame) -> Expression:
        ...
        try:
            ...
            raise OperandDeduceError(
                ''.join(['Incorrect number of arguments for #[', '{}'.format(self.name), '].']))
...
def build_global_frame():
    ...
    for name in ['acos', 'acosh', 'asin', 'asinh', 'atan', 'atanh', 'ceil', 'copysign', 'cos', 'cosh', 'degrees', 'floor', 'log', 'log10', 'log1p', 'log2', 'radians', 'sin', 'sinh', 'sqrt', 'tan', 'tanh', 'trunc']:
